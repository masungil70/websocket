...
<body>
	<h3>필수입력사항</h3>
	<form name="mForm" id="mForm" action="${contextPath}/member/addMember.do" method="post">	
	<div id="detail_table">
		<table>
			<tbody>
				<tr class="dot_line">
	...
	<h1><a href="<c:url value='/chat/chat1'/>">chat1</a></h1>
	<h1><a href="<c:url value='/chat/chat2'/>">chat2</a></h1>
  <h1><a href="<c:url value='/chat/chat3'/>">chat3</a></h1>
  <h1><a href="<c:url value='/board/insert.do'/>">게시물 등록</a></h1>
